...
LONG WINAPI CrashFilter( PEXCEPTION_POINTERS pExp )
{
    ...
    case EXCEPTION_ACCESS_VIOLATION:
        ...
        {
        case 0:
            msgPtr += sprintf( msgPtr, "Read violation at address 0x%" PRIxPTR ".", (uintptr_t) pExp->ExceptionRecord->ExceptionInformation[1] );
            break;
        case 1:
            msgPtr += sprintf( msgPtr, "Write violation at address 0x%" PRIxPTR ".", (uintptr_t) pExp->ExceptionRecord->ExceptionInformation[1] );
            break;
        case 8:
            msgPtr += sprintf( msgPtr, "DEP violation at address 0x%" PRIxPTR ".", (uintptr_t) pExp->ExceptionRecord->ExceptionInformation[1] );
            break;
        default:
            break;
        }
